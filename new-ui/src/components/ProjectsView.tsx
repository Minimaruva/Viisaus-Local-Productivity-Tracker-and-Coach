...
import {
  Plus, Trash2, Edit3, X, Check, AppWindow, Music, Shield,
  Clock, ChevronRight, FolderOpen, Settings2
} from 'lucide-react';
import { Project, PROJECT_COLORS, PROJECT_ICONS } from '@/types/project';
...
interface ProjectsViewProps {
  ...
  onSelectForFocus?: (project: Project) => void;
}

export default function ProjectsView({ projects, onAdd, onUpdate, onRemove, onSelectForFocus }: ProjectsViewProps) {
  ...
  const handleStartFocus = (project: Project) => {
    onSelectForFocus?.(project);
  };
            ...
            <div className="glass-card p-4 space-y-3">
              ...
              <div className="flex items-center gap-4">
                ...
                <label className="flex items-center gap-1.5 cursor-pointer ml-auto">
                  ...
                  <span className="text-[10px] font-semibold text-muted-foreground flex items-center gap-0.5"><Shield className="w-3 h-3" /> Strict</span>
                </label>
              </div>
                    ...
                    <div className="px-4 pb-3 pt-1 border-t border-border/30 space-y-2.5">
                      ...
                      <div className="rounded-lg bg-muted/50 border border-border/50 p-2.5 text-[10px] text-muted-foreground space-y-1">
                        ...
                        <ul className="list-disc list-inside space-y-0.5 ml-1">
                          ...
                          <li>Webcam posture tracking per project</li>
                        </ul>
                      </div>
                      ...
                      <div className="flex gap-2">
                        <button
                          onClick={(e) => { e.stopPropagation(); handleStartFocus(project); }}
