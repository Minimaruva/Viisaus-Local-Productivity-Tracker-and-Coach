...
export type PanelId = 'dashboard' | 'calendar' | 'projects' | 'focus' | 'settings';
...
export default function AppSidebar({ activePanel, onPanelChange, isSessionActive }: AppSidebarProps) {
  return (
