...
function ToggleRow({ icon, label, description }) {
  const [enabled, setEnabled] = useState(false);
  return (
    <div className="flex items-center justify-between gap-4">
      <div className="flex items-start gap-3">
        <div className="w-8 h-8 rounded-lg bg-accent flex items-center justify-center text-muted-foreground shrink-0 mt-0.5">
          {icon}
        </div>
        <div>
...
export default function SettingsView({ blocklist, onAdd, onRemove }) {
